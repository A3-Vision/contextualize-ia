...
**Se** o mesmo repositório contiver o pacote Contextualize IA, podem existir também na raiz (somente referência; o agente não edita): `cliente/`, `home.html`, `README.md` do produto.
